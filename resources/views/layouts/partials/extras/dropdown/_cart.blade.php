...
@else
    {{-- Header --}}
    <div class="d-flex align-items-center py-10 px-8 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url('{{ global_asset('media/misc/bg-1.jpg') }}')">
...
<div class="scroll scroll-push" data-scroll="true" data-height="250" data-mobile-height="200">
    ...
    <div class="d-flex align-items-center justify-content-between p-8">
        ...
        <a href="#" class="symbol symbol-70 flex-shrink-0">
            <img src="{{ global_asset('media/stock-600x400/img-1.jpg') }}" title="" alt=""/>
        </a>
    </div>
    ...
    <div class="d-flex align-items-center justify-content-between p-8">
        ...
        <a href="#" class="symbol symbol-70 flex-shrink-0">
            <img src="{{ global_asset('media/stock-600x400/img-2.jpg') }}" title="" alt=""/>
        </a>
    </div>
    ...
    <div class="d-flex align-items-center justify-content-between p-8">
        ...
        <a href="#" class="symbol symbol-70 flex-shrink-0">
            <img src="{{ global_asset('media/stock-600x400/img-3.jpg') }}" title="" alt=""/>
        </a>
    </div>
    ...
    <div class="d-flex align-items-center justify-content-between p-8">
        ...
        <a href="#" class="symbol symbol-70 flex-shrink-0">
            <img src="{{ global_asset('media/stock-600x400/img-4.jpg') }}" title="" alt=""/>
        </a>
    </div>
</div>
