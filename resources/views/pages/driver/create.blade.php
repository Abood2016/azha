...
<div class="d-flex flex-column-fluid">
    ...
    <div class="container">
        <!--begin::Card-->
        <x-metronic.form-card action="{{ route('drivers.store') }}" method="POST" enctype="multipart/form-data">
            <x-slot name="body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-sm-12 mb-4">
                        ...
                        <x-metronic.input id="licence_number" name="licence_number" type="text" class="mt-1 block w-full"
                            autocomplete="licence_number" value="{{ old('licence_number') }}"/>
                    ...
                    <div class="col-lg-6 col-sm-12 mb-4">
                        ...
                        <x-metronic.input id="licence_expire_date" name="licence_expire_date" type="text" class="mt-1 block w-full"
                            readonly value="{{ old('licence_expire_date') }}"/>
                        <x-metronic.input-error for="licence_expire_date" class="mt-2" />
                    </div>
                    <div class="col-lg-6 col-sm-12 mb-4">
                        <x-metronic.label for="vehicle_brand" value="{{ __('Vehicle Brand') }}" />
                        <x-metronic.input id="vehicle_brand" name="vehicle_brand" type="text" class="mt-1 block w-full"
                            autocomplete="vehicle_brand" value="{{ old('vehicle_brand') }}"/>
                        <x-metronic.input-error for="vehicle_brand" class="mt-2" />
                    </div>
                    <div class="col-lg-6 col-sm-12 mb-4">
                        <x-metronic.label for="vehicle_model" value="{{ __('Vehicle Model') }}" />
                        <x-metronic.input id="vehicle_model" name="vehicle_model" type="text" class="mt-1 block w-full"
                            autocomplete="vehicle_model" value="{{ old('vehicle_model') }}"/>
                        <x-metronic.input-error for="vehicle_model" class="mt-2" />
                    </div>
                    <div class="col-lg-6 col-sm-12 mb-4">
                        <x-metronic.label for="vehicle_name" value="{{ __('Vehicle Name') }}" />
                        <x-metronic.input id="vehicle_name" name="vehicle_name" type="text" class="mt-1 block w-full"
                            autocomplete="vehicle_name" value="{{ old('vehicle_name') }}"/>
                        <x-metronic.input-error for="vehicle_name" class="mt-2" />
                    </div>
                    <div class="col-lg-6 col-sm-12 mb-4">
                        <x-metronic.label for="vehicle_color" value="{{ __('Vehicle Color') }}" />
                        <x-metronic.input id="vehicle_color" name="vehicle_color" type="text" class="mt-1 block w-full"
                            autocomplete="vehicle_color" value="{{ old('vehicle_color') }}"/>
                        <x-metronic.input-error for="vehicle_color" class="mt-2" />
                    </div>
                    <div class="col-lg-6 col-sm-12 mb-4">
                        <x-metronic.label for="vehicle_registration_number" value="{{ __('Vehicle Registration Number') }}" />
                        <x-metronic.input id="vehicle_registration_number" name="vehicle_registration_number" type="text" class="mt-1 block w-full"
                            autocomplete="vehicle_registration_number" value="{{ old('vehicle_registration_number') }}"/>
                    ...
                    <div class="col-lg-6 col-sm-12 mb-4">
                        ...
                        <x-metronic.input id="vehicle_purchase_year" name="vehicle_purchase_year" type="text" class="mt-1 block w-full"
                            readonly value="{{ old('vehicle_purchase_year') }}"/>
