...
@section('content')
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            <!--begin::Card-->
            <x-metronic.form-card action="{{ route('recruiters.store') }}" method="POST" enctype="multipart/form-data">
                <x-slot name="body">
                    <div class="form-group row">
                        <div class="col-12 mb-4">
                            <x-metronic.label for="avatar" value="{{ __('الصورة الشخصية') }}"/>
                            <div class="col-9 p-0">
                        ...
                        <div class="col-lg-6 col-sm-12 mb-4">
                            <x-metronic.label for="password" value="{{ __('كلمة المرور') }}"/>
...
{{--                        <div class="col-lg-6 col-sm-12 mb-4">--}}
{{--                            <x-metronic.label for="password_confirmation" value="{{ __('تأكيد كلمة المرور') }}"/>--}}
{{--                            <x-metronic.input id="password_confirmation" name="password_confirmation" type="password"--}}
