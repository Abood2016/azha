...
class CancelOrderByDriverToCustomer extends Notification
{
    use Queueable;
    ...
    public function toFcm($notifiable)
    {
        return FcmMessage::create()
            ->setData(['order_id' => strval($this->order_id), 'type' => 'cancel_order_by_driver'])
            ->setNotification(\NotificationChannels\Fcm\Resources\Notification::create()
                ->setTitle('azhal: Cancel Order')
                ->setBody('The order has been canceled by driver.'))
            ->setAndroid(
